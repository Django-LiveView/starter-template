"""
Django settings for ccstech project.
...
ALLOWED_HOSTS = (
    ...
    + [os.environ.get("CCSTECH_WEB_SERVICE_HOST")]
    + ["django"]
)
...
WSGI_APPLICATION = "ccstech.wsgi.application"
...
ASGI_APPLICATION = "ccstech.asgi.application"
STATIC_URL = "/static/"
